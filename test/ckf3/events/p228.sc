...
void main(event_args_t *args)
{
	...
	PlaySound(idx, origin, CHAN_WEAPON, "weapons/p228-1.wav", 1.0, 0.8, 0, 94 + RandomLong(0, 15));
	...
	FireBullets(idx, forward, right, up, 1, vecSrc, vecAiming, vSpread, 8192, BULLET_PLAYER_357SIG, 2);
}