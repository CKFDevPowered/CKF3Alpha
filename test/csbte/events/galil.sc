...
void main(event_args_t *args)
{
	...
	if (RandomLong(0, 1))
		PlaySound(idx, origin, CHAN_WEAPON, "weapons/galil-1.wav", 1.0, 0.4, 0, 94 + RandomLong(0, 15));
	else
		PlaySound(idx, origin, CHAN_WEAPON, "weapons/galil-2.wav", 1.0, 0.4, 0, 94 + RandomLong(0, 15));
