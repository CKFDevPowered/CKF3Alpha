...
void main(event_args_t *args)
{
	...
	if (IsLocal(idx))
	{
		...
		CreateSmoke(ent->attachment[0], forward, 50, 0.2, 20, 20, 20, 2, velocity, false, 35);
	}
	...
	PlaySound(idx, origin, CHAN_WEAPON, "weapons/fiveseven-1.wav", 1.0, 0.8, 0, 94 + RandomLong(0, 15));
