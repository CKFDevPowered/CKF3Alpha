...
void main(event_args_t *args)
{
	...
	if (IsLocal(idx))
	{
		...
		CreateSmoke(ent->attachment[0], forward, 3, 0.2, 18, 18, 18, 4, velocity, false, 35);
	}
	...
	EjectBrass(ShellOrigin, ShellVelocity, angles[1], FindModelIndex("models/rshell.mdl"), TE_BOUNCE_SHELL, idx, 15);

	PlaySound(idx, origin, CHAN_WEAPON, "weapons/sg552-1.wav", 1.0, 0.4, 0, 94 + RandomLong(0, 15));
