...
float CHalfLifeRules::IPointsForKill(CBasePlayer *pAttacker, CBaseEntity *pKilled)
{
	return 1;
}
...
void CHalfLifeRules::DeathNotice(CBasePlayer *pVictim, entvars_t *pevKiller, entvars_t *pevInflictor, entvars_t *pevAssister)
{
}
