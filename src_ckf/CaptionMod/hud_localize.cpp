...
wchar_t g_wszBuildables[4][64];
char g_szBuildables[4][64];
...
int HudLocalize_VidInit(void)
{
	...
	_LocalizeStringUnicode(g_wszDisguise,  "#CKF3_Demolish");
