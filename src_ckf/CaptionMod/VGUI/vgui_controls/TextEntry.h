...
public:
	...
	MESSAGE_FUNC_INT( ClickCandidate, "DoClickCandidate", keys );
...
protected:
	...
	virtual int  DrawChar(wchar_t ch, HFont font, int index, int x, int y, bool drawSelectBG = true);
	...
	MESSAGE_FUNC_WCHARPTR( OnInsertText, "InsertText", wtext );
...
private:
	...
	bool				_customCmpositionColor;
	Color				_cmpositionBgColor;
