...
void ColumnButton::ApplySchemeSettings(IScheme *pScheme)
{
	...
	const char *enableImage = pScheme->GetResourceString("ListPanel.ColumnHeaderLeftC");

	if (enableImage[0])
	{
		_imageBackground = true;
		_depressedImage[0] = scheme()->GetImage(enableImage, true);
		_depressedImage[1] = scheme()->GetImage(pScheme->GetResourceString("ListPanel.ColumnHeaderCenterC"), true);
		_depressedImage[2] = scheme()->GetImage(pScheme->GetResourceString("ListPanel.ColumnHeaderRightC"), true);
		_defaultImage[0] = scheme()->GetImage(pScheme->GetResourceString("ListPanel.ColumnHeaderLeftN"), true);
		_defaultImage[1] = scheme()->GetImage(pScheme->GetResourceString("ListPanel.ColumnHeaderCenterN"), true);
		_defaultImage[2] = scheme()->GetImage(pScheme->GetResourceString("ListPanel.ColumnHeaderRightN"), true);
		_armedImage[0] = scheme()->GetImage(pScheme->GetResourceString("ListPanel.ColumnHeaderLeftO"), true);
		_armedImage[1] = scheme()->GetImage(pScheme->GetResourceString("ListPanel.ColumnHeaderCenterO"), true);
		_armedImage[2] = scheme()->GetImage(pScheme->GetResourceString("ListPanel.ColumnHeaderRightO"), true);
	}
}
