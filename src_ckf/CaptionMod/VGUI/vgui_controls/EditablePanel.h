...
public:
	...
	virtual bool LoadControlSettings(const char *dialogResourceName, const char *pathID = NULL, KeyValues *pPreloadedKeyValues = NULL);
	virtual bool LoadControlSettingsFromScheme(const char *dialogResourceName, const char *pathID = NULL, KeyValues *pPreloadedKeyValues = NULL);
	...
	virtual void LoadUserConfigFromScheme(const char *configName, int dialogID = 0);
	...
	virtual void LoadControlSettingsAndUserConfigFromScheme(const char *dialogResourceName, int dialogID = 0);
	...
	*/	
	...
	virtual void RegisterControlSettingsFileEx(const char *dialogResourceName, const char *pathID = NULL);
...
protected:
	...
	const char *GetFileSchemeFullPath(const char *fileName);
