...
void ScrollBarSlider::ApplySchemeSettings(IScheme *pScheme)
{
	...
	_armedFgColor = GetSchemeColor("ScrollBarSlider.ArmedFgColor", pScheme);
	_armedBgColor = GetSchemeColor("ScrollBarSlider.ArmedBgColor", pScheme);
	_selectedFgColor = GetSchemeColor("ScrollBarSlider.SelectedFgColor", pScheme);
	_selectedBgColor = GetSchemeColor("ScrollBarSlider.SelectedBgColor", pScheme);
}
...
Color ScrollBarSlider::GetFgColor()
{
	if(_dragging)
...
Color ScrollBarSlider::GetBgColor()
{
	if(_dragging)
