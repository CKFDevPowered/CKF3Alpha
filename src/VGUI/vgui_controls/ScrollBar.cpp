...
public:
	...
	virtual void ApplySchemeSettings(IScheme *pScheme)
	{
		...
		SetSelectedColor(GetSchemeColor("ScrollBarButton.SelectedFgColor", pScheme), GetSchemeColor("ScrollBarButton.SelectedBgColor", pScheme));
