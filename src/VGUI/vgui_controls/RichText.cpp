...
{	
	...
	m_pEditMenu->AddMenuItem("#RichText_Copy", new KeyValues("DoCopySelected"), this);
...
void RichText::OpenEditMenu()
{
	...
	*/
	...
	{
		m_pEditMenu->SetItemEnabled("#RichText_Cut", true);
		m_pEditMenu->SetItemEnabled("#RichText_Copy", true);
	}
	else	// there is nothing selected, disable cut/copy options
	{
		m_pEditMenu->SetItemEnabled("#RichText_Cut", false);
		m_pEditMenu->SetItemEnabled("#RichText_Copy", false);
	}
