...
public:
	...
	vgui::IHTMLEvents *GetEvents(void) { return m_events; }

public:
	virtual void OnPaint(HDC hDC);
	virtual vgui::IImage *GetBitmap(void) { return m_Bitmap; }
...
private:
	bool CheckIsLink(struct IHTMLElement *el, char *type);
...
private:
	...
	HWND m_ieHWND;
	vgui::VPANEL m_vcontext;
	vgui::IHTMLEvents *m_events;
	HDC hdcMem;
	HDC lasthDC;
	HBITMAP hBitmap;
	vgui::MemoryBitmap *m_Bitmap;
